const en = {
    ...
    plan: 'Plan',
    accountAvailability: 'Account status',
    checkAccountStatus: 'Check plan and status',
    checkCurrentPage: 'Check this page',
    checkingAccountStatus: 'Checking',
    accountStatusChecked: 'Plan and account status updated',
    accountStatusBatchChecked: 'Checked {checked}/{total} accounts',
