const zh = {
    ...
    remark: '备注',
    remarkPlaceholder: '点击输入备注',
    remarkSaved: '备注已保存',
    plan: '套餐',
    accountAvailability: '账号状态',
    checkAccountStatus: '检查套餐与状态',
    checkCurrentPage: '一键检查本页',
    checkingAccountStatus: '正在检查',
    accountStatusChecked: '套餐与账号状态已更新',
    accountStatusBatchChecked: '已检查 {checked}/{total} 个账号',
    lastChecked: '上次检查',
    notChecked: '未检查',
    tabReceived: '收件数量',
    tabSent: '发件数量',
